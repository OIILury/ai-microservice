def build_rag_prompt(requete: str, contexte_chunks: list[str]) -> list[dict]:
    ...
    system_prompt = (
        ...
        "1. Si la réponse ne se trouve pas dans le contexte fourni, réponds exactement : \"Je n'ai pas trouvé cette information dans ma base de connaissances.\"\n"
        "2. N'invente jamais d'information qui n'est pas explicitement présente dans le contexte.\n"
        "3. Rédige une réponse claire et concise, 2 à 3 phrases maximum.\n"
        "4. Si et seulement si une page parmi cette liste est pertinente pour la question, termine ta réponse par une nouvelle ligne contenant EXACTEMENT 'LIEN: ' suivi de l'URL. Liste autorisée : /accueil, /contact, /faq, /a-propos, /tarifs, /produits.\n"
